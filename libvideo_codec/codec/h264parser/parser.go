...
import (
	...
	"McuConference/libvideo_codec/utils/bits"
	"McuConference/libvideo_codec/utils/bits/pio"
)
...
//func NewCodecDataFromSPSAndPPSForH265(sps, pps []byte) (self CodecData, err error) {
//	recordinfo := AVCDecoderConfRecord{}
//	recordinfo.SPS = [][]byte{sps}
//	recordinfo.PPS = [][]byte{pps}
//	return
